...
class appDevDebugProjectContainer extends Container
{
     ...
     *
     * @return \AppBundle\Twig\CountryExtension A AppBundle\Twig\CountryExtension instance
     */
    protected function getAcme_Twig_AcmeExtensionService()
    {
        return $this->services['acme.twig.acme_extension'] = new \AppBundle\Twig\CountryExtension();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\UserLocaleListener A AppBundle\EventListener\UserLocaleListener instance
     */
    protected function getApp_UserLocaleListenerService()
    {
        return $this->services['app.user_locale_listener'] = new \AppBundle\EventListener\UserLocaleListener($this->get('session'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KbCKxXIEfr', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C3LPQPaAPt', 0, 'ViKi7dRxCcXtLP0ipHOS9A', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cAgz1-gdQb', 0, 'ViKi7dRxCcXtLP0ipHOS9A', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7gC7ma8Sdu', 0, 'ViKi7dRxCcXtLP0ipHOS9A', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'padelapp_backend', 'user' => 'postgres', 'password' => 'luis1411', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f505a9710fa0eeb21a82c2521e8110c4353ecb739552407ec07bd9fed3eed21f');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\AuthUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(es|en)/public');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(es|en)/email');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(es|en)/web');
        ...
        $k->add($j, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_STAFF'), NULL);
        ...
        $n->setOptions(array('login_path' => 'login', 'default_target_path' => 'postLogin', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('pgluisangel@gmail.com');
        $a->setPassword('eprahim!1411');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AsseticBundle', 8 => 'FOSJsRoutingBundle', 9 => 'AppBundle', 10 => 'DebugBundle', 11 => 'WebProfilerBundle', 12 => 'SensioDistributionBundle', 13 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('SecretTokePadelAppLuisToken');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:AuthUser', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 5432,
            'database_name' => 'padelapp_backend',
            'database_user' => 'postgres',
            'database_password' => 'luis1411',
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'pgluisangel@gmail.com',
            'mailer_password' => 'eprahim!1411',
            'secret' => 'SecretTokePadelAppLuisToken',
            'locale' => 'en',
            'user_image_directory' => ($this->targetDirs[3].'/app/../web/bundles/web/img/usersProfiles'),
            'club_image_directory' => ($this->targetDirs[3].'/app/../web/bundles/web/img/clubs'),
            'dummy_image_directory' => ($this->targetDirs[3].'/app/../web/bundles/web/img/dummy'),
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'SecretTokePadelAppLuisToken',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'pgluisangel@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'eprahim!1411',
