 ...
 */
class DummyPlayer extends \AppBundle\Entity\DummyPlayer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DummyPlayer' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\DummyPlayer' . "\0" . 'equipment', '' . "\0" . 'AppBundle\\Entity\\DummyPlayer' . "\0" . 'level', '' . "\0" . 'AppBundle\\Entity\\DummyPlayer' . "\0" . 'creator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DummyPlayer $proxy) {
