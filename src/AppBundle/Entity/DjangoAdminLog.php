 ...
 * DjangoAdminLog
 *
 * @ORM\Table(name="django_admin_log", indexes={@ORM\Index(name="django_admin_log_417f1b1c", columns={"content_type_id"}), @ORM\Index(name="django_admin_log_e8701ad4", columns={"user_id"})})
 * @ORM\Entity
 */
