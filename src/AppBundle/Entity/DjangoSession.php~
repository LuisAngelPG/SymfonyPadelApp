 ...
 * DjangoSession
 *
 * @ORM\Table(name="django_session", indexes={@ORM\Index(name="django_session_session_key_461cfeaa630ca218_like", columns={"session_key"}), @ORM\Index(name="django_session_de54fa62", columns={"expire_date"})})
 * @ORM\Entity
 */
class DjangoSession
{
