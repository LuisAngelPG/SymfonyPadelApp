...
class TournamentDummyparticipant
{
    ...
    /**
     * @var \AppBundle\Entity\DummyPlayer
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\DummyPlayer")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="dummy_player_id", referencedColumnName="id")
     * })
     */
    private $player;
     ...
     * Set player
     *
     * @param \AppBundle\Entity\DummyPlayer $player
     *
     * @return TournamentPlayerparticipant
     */
    public function setPlayer(\AppBundle\Entity\DummyPlayer $player = null)
    {
        $this->player = $player;
     ...
     * Get player
     *
     * @return \AppBundle\Entity\DummyPlayer
     */
