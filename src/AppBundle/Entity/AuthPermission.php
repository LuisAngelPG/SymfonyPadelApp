 ...
 * AuthPermission
 *
 * @ORM\Table(name="auth_permission", uniqueConstraints={@ORM\UniqueConstraint(name="auth_permission_content_type_id_codename_key", columns={"content_type_id", "codename"})}, indexes={@ORM\Index(name="auth_permission_417f1b1c", columns={"content_type_id"})})
 * @ORM\Entity
 */
